...
public class students extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection con= DriverManager.getConnection("jdbc:mysql://localhost/huye2023","root","");
        PreparedStatement pst= con.prepareStatement("UPDATE student SET name=?, age=?, gender=? WHERE id=?");
        ...
        pst.setString(4, id);
        pst.executeUpdate();
           JOptionPane.showMessageDialog(jButton3,"Update Successfully!!"); 
       }
       catch(Exception e){
          // Logger.getLogger(Student_reg.class.getName().log(Level.SEVERE,null,e));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       try{
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con= DriverManager.getConnection("jdbc:mysql://localhost/huye2023","root","");
        PreparedStatement pst= con.prepareStatement("INSERT INTO student(name,age,gender) VALUES(?,?,?)");
        pst.setString(1, name);
        pst.setString(2, age);
        if(jRadioButton1.isSelected()){
            pst.setString(3,jRadioButton1.getText());
        ...
        pst.executeUpdate();
           JOptionPane.showMessageDialog(jButton3,"Inserted Successfully!!"); 
       }
       catch(Exception e){
          // Logger.getLogger(Student_reg.class.getName().log(Level.SEVERE,null,e));
          System.out.println(e.getMessage());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pst.setString(1, id);
        pst.executeUpdate();
           JOptionPane.showMessageDialog(jButton3,"Delete Successfully!!"); 
       }
       catch(Exception e){
          // Logger.getLogger(Student_reg.class.getName().log(Level.SEVERE,null,e));
          System.out.println(e.getMessage());
